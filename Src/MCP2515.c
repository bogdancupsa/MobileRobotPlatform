...
#define MCP2515_CS_HIGH()       HAL_GPIO_WritePin(SPI3_CS_CAN_GPIO_Port, SPI3_CS_CAN_Pin, GPIO_PIN_SET)
#define MCP2515_CS_LOW()        HAL_GPIO_WritePin(SPI3_CS_CAN_GPIO_Port, SPI3_CS_CAN_Pin, GPIO_PIN_RESET)
